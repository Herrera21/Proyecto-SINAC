<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Html/PaginaEstandar.Master" AutoEventWireup="true" CodeBehind="RMenuAreaConserv.aspx.cs" Inherits="Sistema.CapaPresentacion.Html.RMenuAreaConserv" %>
        ...
        <div class="row" style="background-color:white; width:99.7%">
            ...
            <div class="row" style="background-color:white; width:99.7%">
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <h1 class="text-center login-title">Registrar Área de Conservación</h1>
                    <div class="account-wall">
                        <form id="form1" class="form-signin" runat="server">
                          ...
                          <div class="form-group has-feedback" id="divAbreviatura">
                            ...
                            <span class="" aria-hidden="true" id="span1Abrev"></span>
                          
                          </div>
                          
                          <div class="form-group has-feedback" id="divUbicacion">
                          ...
                          <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Guardar" OnClick="Button1_Click" OnClientClick="area()"/>
                        </form>
                    </div>
                </div>
            </div>
