...
{
    public partial class CAreaConserv : System.Web.UI.Page
    {
        ...
        private string seleccionar(int index)
        {
            ...
            return Convert.ToString(GridView1.DataKeys[index].Values["nombre"]);
        }
        ...
        {
            Response.Redirect("RMenuAreaConserv.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                ...
                Response.Redirect("MMenuAreaConserv.aspx");
            }
        }
