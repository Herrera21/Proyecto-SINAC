<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Html/PaginaEstandar.Master" EnableEventValidation = "false" AutoEventWireup="true" CodeBehind="CIncendForest.aspx.cs" Inherits="Sistema.CapaPresentacion.Html.BombForest.CIncendForest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderContenido" runat="server">
      ...
      <!-- menu-->
        <ul class="nav nav-tabs" style="background-color:#D8D8D8;">
            ...
            <li class="dropdown active"><a href="CIncendForest.aspx">Evento de incendio forestal</a></li>
            ...
            <script>
                ...
                <form id="form1" runat="server">
                        ...
                        <div id="filtro" class="modal" data-backdrop="static" data-keyboard="false" style="display: none; ">
                                ...
                                <div class="modal-header">
                                    <asp:DropDownList ID="columna" class="form-control" runat="server">
                                        <asp:listitem value ="lugar"> Lugar del incendio </asp:listitem>
                                        <asp:listitem value ="fechaParticipacion"> Fecha de participación </asp:listitem>
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" style="padding-left:20%;">
                        <div class="col-md-2" >
                            <asp:ImageButton ID="buttonAgregar" data-toggle="tooltip" title="Crear evento de incendio forestal"  runat="server"  ImageUrl="~/Imagenes/Icono_Agregar.png" CssClass="Imagen_boton" Text="Crear"  OnClick="buttonAgregar_Click" />
                        </div>
                        ...
                        <div class="col-md-2">
                            <asp:ImageButton ID="buttonConsultar" data-toggle="tooltip" title="Asignar a Bomberos" ImageUrl="~/Imagenes/icono_Asignar.png" onmouseover="this.width=400;this.height=300;" onmouseout="this.width=100;this.height=80;" width="100" height="80"  CssClass="Imagen_boton" Text="Consultar" runat="server" OnClick="buttonConsultar_Click" />
                        </div>
                        ...
                        <div class="col-md-2">
                            <asp:ImageButton ID="buttonImprimir" data-toggle="tooltip" title="Imprimir los eventos de incendios forestales" runat="server" ImageUrl="~/Imagenes/Icono_Imprimir.png" CssClass="Imagen_boton" Text="Imprimir" OnClick="buttonImprimir_Click" />
                        </div>
                    </div>

                    <hr />

                    <h1 class="text-center login-title">Eventos de incendios forestales</h1>
