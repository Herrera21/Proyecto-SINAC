...
namespace Sistema.CapaPresentacion.Html.Mantenimiento
{
    public partial class AsignarActivPrevenc : System.Web.UI.Page
    {
        ...
        private void BindData(bool activo)
        {
            ...
            GridView1.DataSource = temp.seleccionar_Dataset_NoActivPrevAsig(activo, VariablesSeccionControl.Lee<int>("ActivPrevenc"), VariablesSeccionControl.Lee<string>("Brigada"), null, null, null);
            GridView1.DataBind();
        }
        ...
        private void BindData(bool activo, string columna, string operador, string valor)
        {
            // cargar los bomberos no asignados con actividad prevenc
            BomberoDB temp = new BomberoDB();
            GridView1.DataSource = temp.seleccionar_Dataset_NoActivPrevAsig(activo, VariablesSeccionControl.Lee<int>("ActivPrevenc"), VariablesSeccionControl.Lee<string>("Brigada"), columna, operador, valor);
            GridView1.DataBind();
        }
        ...
        private void BindData2(bool activo)
        {
            ...
            BomberoDB temp = new BomberoDB();
            GridView2.DataSource = temp.seleccionar_Dataset_ActivPrevAsig(activo, VariablesSeccionControl.Lee<int>("ActivPrevenc"), VariablesSeccionControl.Lee<string>("Brigada"), null, null, null);
            GridView2.DataBind();
        }
        ...
        private void BindData2(bool activo, string columna, string operador, string valor)
        {
            // cargar los bomberos asignados con actividad prevenc
            BomberoDB temp = new BomberoDB();
            GridView2.DataSource = temp.seleccionar_Dataset_ActivPrevAsig(activo, VariablesSeccionControl.Lee<int>("ActivPrevenc"), VariablesSeccionControl.Lee<string>("Brigada"), columna, operador, valor);
            GridView2.DataBind();
        }
