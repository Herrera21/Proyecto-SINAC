<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Html/PaginaEstandar.Master" AutoEventWireup="true" CodeBehind="AsignarActivPrevenc.aspx.cs" Inherits="Sistema.CapaPresentacion.Html.Mantenimiento.AsignarActivPrevenc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderContenido" runat="server">
    <div class="container">
        ...
        <PagerStyle CssClass="pgr" BackColor="#284775" ForeColor="White" HorizontalAlign="Center"></PagerStyle>
                    ...
                    <asp:ImageButton ID="buttonAgregar" data-toggle="tooltip" title="Asignar actividad de prevención"  runat="server"  ImageUrl="~/Imagenes/flechaAbajo.png" CssClass="Imagen_boton" Text="Asignar Póliza"  OnClick="buttonAgregar_Click" />
                    ...
                    <br />
                    <br />
                   <h1 class="text-center login-title" id="H1" runat="server">Bomberos con la actividad de prevención</h1>
                   <div style="padding-left:9.7%"> 
