...
{
    public partial class CCapacitación : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("RCapacitación.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                ...
                Response.Redirect("MCapacitación.aspx");
            }
        }
        ...
        protected void buttonImprimir_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Charset = "";
            Response.AddHeader("content-disposition", "attachment;filename=ReporteCapacitaciones.xls");
