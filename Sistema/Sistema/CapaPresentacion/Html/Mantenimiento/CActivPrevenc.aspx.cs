...
{
    public partial class CActivPrevenc1 : System.Web.UI.Page
    {
        ...
        {
            ActivPrevencDB temp = new ActivPrevencDB();
        ...
        private int seleccionar(int index)
        {
            ...
            //
            return Convert.ToInt32(GridView1.DataKeys[index].Values["PK_Id_ActividadPrevencion"]);
        }
        ...
        {
            Response.Redirect("RActivPrevenc.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                ...
                Response.Redirect("MActivPrevenc.aspx");
            }
        }
