                    ...
                    <div class="account-wall">
                        ...
                        <div id="alert" class="modal" data-backdrop="static" data-keyboard="false" style="display: none; ">
                          ...
                          <div class="form-group has-feedback has-success" id="divCantEntre">
                            ...
                            <span class="glyphicon form-control-feedback icon-checkmark" aria-hidden="true" id="span1CantEntre"></span>
                          </div>
                          <div class="form-group has-feedback has-success" id="divFechaEntreg">
                            ...
                            <span class="glyphicon form-control-feedback icon-checkmark" aria-hidden="true" id="span1FechaEntreg"></span>
                          </div>
                          <div class="form-group has-feedback has-success" id="divEstado">
                            <label>Estado</label>
                            ...
                            <span class="form-group has-feedback has-success" aria-hidden="true" id="span1Estado"></span>
                          </div>
