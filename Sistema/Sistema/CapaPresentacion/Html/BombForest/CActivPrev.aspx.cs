...
{
    public partial class CActivPrev : System.Web.UI.Page
    {
        ...
        private void BindData(bool activo)
        {
            ...
            GridView1.DataSource = temp.seleccionar_Dataset_AsignActivPrev(VariablesSeccionControl.Lee<string>("Bombero"));
            GridView1.DataBind();
        }
