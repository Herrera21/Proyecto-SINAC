            ...
            <script>
                ...
                <form id="form1" runat="server">
                    <!--filtro-->
                        <%--<div id="filtro" class="modal" style="display: none; ">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <asp:Button ID="botonBorrarFiltros" runat="server" Text="Borrar filtros" class="btn btn-primary" OnClick="buttonBorraFiltros"/>
                   ...
                   <div class="row" style="padding-left:20%;">
                        <div class="col-md-2" >
                            <asp:ImageButton ID="buttonAgregar" data-toggle="tooltip" title="Crear un Bombero"  runat="server"  ImageUrl="~/Imagenes/Icono_Agregar.png" CssClass="Imagen_boton" Text="Crear"  OnClick="buttonAgregar_Click" />
                        </div>
...
<%--                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <asp:ImageButton ID="Imprimir" data-toggle="tooltip" title="Imprimir lista de Bomberos" runat="server" ImageUrl="~/Imagenes/Icono_Imprimir.png" CssClass="Imagen_boton" Text="Imprimir" OnClick="Imprimir_Click" />
                        </div>
                    </div>
