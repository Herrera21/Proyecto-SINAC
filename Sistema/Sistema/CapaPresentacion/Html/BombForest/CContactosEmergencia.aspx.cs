...
{
    public partial class CContactosEmergencia : System.Web.UI.Page
    {
        ...
        {
            ContactosEmergenciaDB temp = new ContactosEmergenciaDB();
        ...
        {
            Response.Redirect("RContactosEmergencia.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                VariablesSeccionControl.Escribe("ContEmer", seleccionar(GridView1.SelectedRow.RowIndex));
                Response.Redirect("MContactosEmergencia.aspx");
            }
        }
