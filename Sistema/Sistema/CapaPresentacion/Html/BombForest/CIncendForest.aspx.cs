...
{
    public partial class CIndendForest : System.Web.UI.Page
    {
        ...
        private void BindData(bool activo)
        {
            ...
            GridView1.DataSource = temp.seleccionar_Dataset_AsignIncendForest(VariablesSeccionControl.Lee<string>("Bombero"));
            GridView1.DataBind();
        }
