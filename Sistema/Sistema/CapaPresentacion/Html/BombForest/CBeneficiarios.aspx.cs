...
{
    public partial class CBeneficiarios : System.Web.UI.Page
    {
        ...
        {
            BomBenefDB temp = new BomBenefDB();
            GridView1.DataSource = temp.seleccionar_Dataset(activo, VariablesSeccionControl.Lee<int>("BomberoPoliza"), null, null, null);
            GridView1.DataBind();
        }
        ...
        {
            BomBenefDB temp = new BomBenefDB();
            GridView1.DataSource = temp.seleccionar_Dataset(activo, VariablesSeccionControl.Lee<int>("BomberoPoliza"), columna, operador, valor);
            GridView1.DataBind();
        }
        private int seleccionar(int index)
        {
            ...
            return Convert.ToInt32(GridView1.DataKeys[index].Values["PK_Id_Beneficiario"]);
        }
        ...
        {
            Response.Redirect("RBeneficiarios.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                VariablesSeccionControl.Escribe("Benef", seleccionar(GridView1.SelectedRow.RowIndex));
                Response.Redirect("MBeneficiarios.aspx");
            }
        }
