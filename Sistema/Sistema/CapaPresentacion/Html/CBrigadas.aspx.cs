...
{
    public partial class CBrigadas : System.Web.UI.Page
    {
        ...
        private void BindData(bool activo)
        {
            ...
            GridView1.DataSource = temp.seleccionar_Dataset(activo, VariablesSeccionControl.Lee<string>("AreaConserv"), null, null, null);
            GridView1.DataBind();
        }
        ...
        private string seleccionar(int index)
        {
            ...
            return Convert.ToString(GridView1.DataKeys[index].Values["nombre_Brigada"]);
        }
        ...
        {
            Response.Redirect("RMenuBrigada.aspx");
        }
        ...
        protected void buttonModificar_Click(object sender, ImageClickEventArgs e)
        {
            if (GridView1.SelectedRow != null)
            {
                ...
                Response.Redirect("MMenuBrigada.aspx");
            }
        }
